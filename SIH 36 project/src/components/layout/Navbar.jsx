...
export const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200">
      {/* Top micro bar for compliance notice */}
      <div className="bg-slate-900 text-slate-300 text-[11px] py-1 px-4 text-center sm:text-left flex flex-col sm:flex-row justify-between items-center max-w-7xl mx-auto font-medium">
        <div className="flex items-center gap-2">
          ...
          <span>Smart India Hackathon 2026 Prototype • Online Verification System for Weighing & Measuring Instruments</span>
        </div>
        <div className="flex items-center gap-3 mt-0.5 sm:mt-0">
          ...
          <button
            ...
            className={`hover:text-white transition-colors ${role === 'business' ? 'text-blue-400 font-bold' : ''}`}
          >
            Business
          </button>
          <span>•</span>
          <button
            ...
            className={`hover:text-white transition-colors ${role === 'inspector' ? 'text-blue-400 font-bold' : ''}`}
          >
            Inspector
          </button>
          <span>•</span>
          <button
            ...
            className={`hover:text-white transition-colors ${role === 'officer' ? 'text-blue-400 font-bold' : ''}`}
          >
            Officer
          </button>
        </div>
