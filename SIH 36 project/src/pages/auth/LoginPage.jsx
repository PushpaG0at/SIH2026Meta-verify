...
export const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setAuthError('Authentication failed. Please verify your credentials and selected role.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="p-3 bg-slate-50 rounded-xl border border-slate-200/80 text-[11px] text-slate-600 space-y-1.5">
        ...
        <div className="grid grid-cols-1 gap-1 text-[10px] font-mono text-slate-600 pt-0.5">
          <span className="truncate">• Business: rajesh@sharmatraders.com</span>
          <span className="truncate">• Inspector: vikram.singh@metraverify.internal</span>
          <span className="truncate">• Officer: anita.deshmukh@metraverify.internal</span>
        </div>
      </div>
