...
export const getStatusConfig = (status) => {
  const map = {
    ...
    OFFICER_APPROVED: { label: 'Officer Approved', color: 'bg-emerald-50 text-emerald-700 border-emerald-200' },
    ...
    AI_REVIEWED: { label: 'AI Pre-Checked', color: 'bg-cyan-50 text-cyan-700 border-cyan-200' },
    INSPECTION: { label: 'Under Inspection', color: 'bg-indigo-50 text-indigo-700 border-indigo-200' },
    INSPECTION_ASSIGNED: { label: 'Inspector Assigned', color: 'bg-indigo-50 text-indigo-700 border-indigo-200' },
    INSPECTION_SCHEDULED: { label: 'Inspection Scheduled', color: 'bg-indigo-50 text-indigo-700 border-indigo-200' },
    INSPECTION_COMPLETED: { label: 'Inspection Completed', color: 'bg-violet-50 text-violet-700 border-violet-200' },
    ...
    CORRECTION_REQUESTED: { label: 'Correction Requested', color: 'bg-amber-50 text-amber-800 border-amber-200' },
    RETURNED_FOR_REINSPECTION: { label: 'Returned for Re-Inspection', color: 'bg-amber-50 text-amber-800 border-amber-200' },
    DRAFT: { label: 'Draft', color: 'bg-slate-100 text-slate-700 border-slate-300' },
    UNVERIFIED: { label: 'Unverified', color: 'bg-slate-100 text-slate-600 border-slate-300' },
    ...
    OFFICER_REJECTED: { label: 'Officer Rejected', color: 'bg-rose-50 text-rose-700 border-rose-200' },
    FLAGGED: { label: 'Flagged', color: 'bg-rose-50 text-rose-700 border-rose-200' },
  ...
  return map[status] || { label: status?.replace(/_/g, ' ') || 'Unknown', color: 'bg-slate-100 text-slate-700 border-slate-200' };
};
